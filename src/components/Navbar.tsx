      ...
      >
        ...
        {!isDashboardPage && (
          <form
            ...
            className="hidden lg:flex items-center mx-4 flex-1 max-w-md relative"
          >
        ...
        <div
          className={`hidden lg:flex gap-6 ${isDashboardPage ? "ml-auto" : ""}`}
        >
          <Link
            href="/properties"
          ...
          {user ? (
            ...
            <>
              <Link href="/auth/login">
                <Button className="px-6 py-2 rounded-lg bg-white text-black font-medium shadow hover:bg-gray-300 transition">
                  Masuk
                </Button>
              </Link>
              <Link href="/auth/register">
                <Button className="px-6 py-2 rounded-lg bg-gray-900 text-white font-medium shadow hover:bg-gray-500 transition">
                  Daftar
                </Button>
              </Link>
            </>
